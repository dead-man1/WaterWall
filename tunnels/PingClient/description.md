...
- downstream packet payload is decapsulated when it matches the configured ICMP identifier and framing
...
- only matching IPv4 ICMP echo-request envelopes with the configured identifier are decapsulated on the return path
